...
class BookingsFunctions{
  ...
  static void bookTourGuide({required BuildContext context , required BookingTourGuideController model , required TourGuideModel tModel }){
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12,),
                const CountryPicker(),
                BookPersonHotel(text: 'Adults',
                  num: AppInfoHelper.instance.adults,),
                BookPersonHotel(text: 'children',
                    ...
                    if (globalKey.currentState!
                      ...
                      await model.bookingToDatabase(
                        imgOfPack: tModel.imagePath,
                          ...
                          numOfPeople: AppInfoHelper.instance.adults+ AppInfoHelper.instance.children,
 ...
 static void bookHotel({required VoidCallback onConfirm ,required HotelModel model , required GlobalKey<FormState> globalKey  }) {
    ...
    Get.defaultDialog(
        ...
        content: Column(children: [
          ...
          BookPersonHotel(text: 'Adults', num: AppInfoHelper.instance.adults) ,
          BookPersonHotel(text: 'Children', num: AppInfoHelper.instance.children) ,
