...
class BookingsComponent {
  ...
  static Widget customTileOfBookGuide(
      ...
      bool? view}) {
    List<Widget> images() {
      List<Widget> img = [Image.network(model.imageOfPacker , fit: BoxFit.fill,)];
    ...
    String eDate = DateTime.parse(model.date).add(Duration(days: model.numOfTrips-1)).toString().substring(0, 11);
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      CustomText(
                        text: model.tittle.substring(0, model.tittle.length-1),
                        size: 14,
                        fontWeight: FontWeight.bold,
                      ),
                ...
                Column(
                  children: [
                    bookStatues(model.status),
                   model.status == true ?  Column(children: [const SizedBox(height: 4,) ,
                     const CustomText(text:' ends in  ', size: 8,fontWeight: FontWeight.bold,),
                     CustomText(text:eDate , size: 8,)],) :
                    const SizedBox(),
